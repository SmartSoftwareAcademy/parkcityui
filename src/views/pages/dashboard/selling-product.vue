...
<div class="card">
    <div class="card-body">
        ...
        <h4 class="card-title mb-4">Top Rated Parking Grounds</h4>
        ...
        <div class="row align-items-center no-gutters mt-3">
            <div class="col-sm-3">
                <p class="text-truncate mt-1 mb-0">
                    <i class="mdi mdi-circle-medium text-info me-2"></i> Agakhan Squre
                </p>
            </div>
            <div class="col-sm-9">
        ...
        <div class="row align-items-center no-gutters mt-3">
            <div class="col-sm-3">
                <p class="text-truncate mt-1 mb-0">
                    <i class="mdi mdi-circle-medium text-success me-2"></i> Sports Ground
                </p>
            </div>
            <div class="col-sm-9">
        ...
        <div class="row align-items-center no-gutters mt-3">
            <div class="col-sm-3">
                <p class="text-truncate mt-1 mb-0">
                    <i class="mdi mdi-circle-medium text-warning me-2"></i> Huduma Squre
                </p>
            </div>
            <div class="col-sm-9">
